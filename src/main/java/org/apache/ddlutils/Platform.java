...
public interface Platform
{
    ...
    default void createDatabase( JDBCDriver driver,String connectionUrl, String username, String password, Map parameters) throws DatabaseOperationException, UnsupportedOperationException {
        createDatabase(driver.value(), connectionUrl, username, password, parameters);
    }
